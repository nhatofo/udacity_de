...
start_time TIMESTAMP REFERENCES time(start_time) ON DELETE RESTRICT,
user_id VARCHAR(50) REFERENCES users(user_id) ON DELETE RESTRICT,
level VARCHAR(50) NOT NULL,
song_id VARCHAR(100) REFERENCES songs(song_id) ON DELETE RESTRICT,
artist_id VARCHAR(100) REFERENCES artists(artist_id) ON DELETE RESTRICT,
session_id BIGINT,
